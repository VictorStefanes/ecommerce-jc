...
export default function CalcasPage() {
  ...
  const products = [
    ...
    {
      id: 2,
      name: "Calça Moletom Essential Cinza",
      price: 99.90,
    ...
    {
      id: 3,
      name: "Calça Cargo Tech Cáqui",
      price: 159.90,
      originalPrice: 199.90,
      image: "/api/placeholder/300/400",
      colors: ["#a16207", "#000000", "#6b7280"],
      sizes: ["P", "M", "G", "GG"],
      rating: 4.7,
      reviews: 156,
      isNew: false,
    ...
    {
      id: 5,
      name: "Calça Track Premium Preto",
      price: 129.90,
    ...
    {
      id: 7,
      name: "Calça Jogger Tech Dry Marinho",
      price: 149.90,
    ...
    {
      id: 8,
      name: "Calça Moletom Comfort Mescla",
      price: 89.90,
      ...
      <section className="page-header">
        <div className="container">
          <div className="header-content">
            <h1>Calças</h1>
            <p>Conforto e versatilidade para o seu dia a dia. Nossa coleção de calças combina estilo e praticidade.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="filter-sort-bar">
            <div className="filter-controls">
              ...
              <span className="products-count">86 produtos</span>
            </div>
