...
import { Star, Filter, ChevronDown, Heart, Eye, ShoppingBag } from 'lucide-react';
import './styles.scss';

export default function CamisetasDryFitPage() {
  ...
  const products = [
    ...
    {
      id: 2,
      name: "Camiseta Dry Fit Performance Branco",
      price: 39.99,
      originalPrice: 42.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 3,
      name: "Camiseta Apex Dry New Lupus Preto - Sem Costura",
      price: 89.99,
      originalPrice: 97.90,
      image: "/api/placeholder/300/400",
      ...
      isLaunch: true,
      badge: "",
      category: "Linha PROAPEX",
      line: "PROAPEX"
    },
    {
      id: 4,
      name: "Camiseta Dry Fit Camuflada New Lupus Verde",
      price: 69.99,
      originalPrice: 79.99,
      image: "/api/placeholder/300/400",
      ...
      isLaunch: false,
      badge: "",
      category: "Linha Advanced",
      line: "Advanced"
    },
    {
      id: 5,
      name: "Camiseta Dry Fit New Fluid Mescla Cinza",
      price: 42.90,
      originalPrice: 49.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 6,
      name: "Camiseta Apex Dry Middle Lupus Marinho - Sem Costura",
      price: 89.99,
      originalPrice: 97.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 7,
      name: "Camiseta Dry Direction Branco",
      price: 42.90,
      originalPrice: 49.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 8,
      name: "Camiseta Dry Fit Camuflada New Tenacity Branca",
      price: 69.99,
      originalPrice: 79.99,
      image: "/api/placeholder/300/400",
      ...
      <section className="page-header">
        <div className="container">
          <div className="header-content">
            <h1>Camisetas</h1>
            <p>Design exclusivo e qualidade superior, unindo estilo e conforto para elevar o seu visual em qualquer ocasião.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="filter-sort-bar">
            <div className="filter-controls">
              ...
              <span className="products-count">132 produtos</span>
            </div>
          ...
          <div className="quick-filters">
            ...
            <button className="quick-filter">Linha PROAPEX</button>
            <button className="quick-filter">Linha Advanced</button>
            <button className="quick-filter">Sem Costura</button>
