...
export default function TopPage() {
  ...
  const products = [
    {
      id: 1,
      name: "Top Feminino Seamless com Bojo Preto",
      price: 69.90,
      originalPrice: 99.90,
      image: "/api/placeholder/300/400",
      colors: ["#000000", "#ec4899", "#6b7280"],
      sizes: ["PP", "P", "M", "G"],
      rating: 4.9,
      reviews: 234,
      isNew: false,
    ...
    {
      id: 2,
      name: "Top Esportivo Dry Fit Rosa Neon",
      price: 59.90,
      originalPrice: 84.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 3,
      name: "Top Cropped Ribana Canelado Branco",
      price: 49.90,
      originalPrice: 74.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 5,
      name: "Top Feminino Alcinha Lurex Dourado",
      price: 79.90,
      originalPrice: 119.90,
      image: "/api/placeholder/300/400",
      colors: ["#f59e0b", "#000000", "#ec4899"],
      sizes: ["PP", "P", "M", "G", "GG"],
      rating: 4.8,
      reviews: 203,
      isNew: false,
    ...
    {
      id: 6,
      name: "Top Nadador Fitness Azul Marinho",
      price: 64.90,
      originalPrice: 94.90,
      image: "/api/placeholder/300/400",
    ...
    {
      id: 7,
      name: "Top Cropped Manga Longa Verde",
      price: 74.90,
      originalPrice: 109.90,
      image: "/api/placeholder/300/400",
      colors: ["#059669", "#000000", "#ec4899"],
      sizes: ["PP", "P", "M", "G"],
      rating: 4.9,
      reviews: 265,
      isNew: false,
    ...
    {
      id: 8,
      name: "Top Franzido Lateral Cinza Mescla",
      price: 69.90,
      originalPrice: 99.90,
      image: "/api/placeholder/300/400",
      ...
      <section className="page-header">
        <div className="container">
          <div className="header-content">
            <h1>Tops Femininos</h1>
            <p>Versatilidade e estilo para treinos e looks casuais. Encontre o top ideal para cada momento.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="filter-sort-bar">
            <div className="filter-controls">
              ...
              <span className="products-count">52 produtos</span>
            </div>
          ...
          <div className="quick-filters">
            ...
            <button className="quick-filter">Com Bojo</button>
            <button className="quick-filter">Seamless</button>
            <button className="quick-filter">Dry Fit</button>
            <button className="quick-filter">Bandeau</button>
