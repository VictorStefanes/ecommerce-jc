...
export default function CamisetasDryBermudasPage() {
  ...
  const products = [
    {
      id: 1,
      name: "Kit Camiseta Dry Fit + Bermuda Essential Preto",
      price: 109.90,
    ...
    {
      id: 2,
      name: "Kit Camiseta Dry Fit + Bermuda Urban Cinza",
      price: 119.90,
    ...
    {
      id: 3,
      name: "Kit Camiseta Dry Fit + Bermuda Tech Marinho",
      price: 129.90,
    ...
    {
      id: 4,
      name: "Kit Camiseta Performance + Bermuda Sport Verde",
      price: 139.90,
    ...
    {
      id: 5,
      name: "Kit Camiseta Dry Fit + Bermuda Premium Branco",
      price: 149.90,
    ...
    {
      id: 6,
      name: "Kit Camiseta Basic + Bermuda Comfort Mescla",
      price: 99.90,
    ...
    {
      id: 7,
      name: "Kit Camiseta Training + Bermuda Active Bordô",
      price: 124.90,
    ...
    {
      id: 8,
      name: "Kit Camiseta Flex + Bermuda Dry Sport Azul",
      price: 134.90,
      ...
      <section className="page-header">
        <div className="container">
          <div className="header-content">
            <h1>Kit Camiseta + Bermuda</h1>
            <p>Combos perfeitos para seu treino e dia a dia. Economize comprando nossos kits exclusivos.</p>
          </div>
        </div>
      </section>
