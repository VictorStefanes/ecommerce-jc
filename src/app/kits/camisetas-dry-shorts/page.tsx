...
export default function CamisetasDryShortsPage() {
  ...
  const products = [
    {
      id: 1,
      name: "Kit Camiseta Dry Fit + Short Essential Preto",
      price: 89.90,
    ...
    {
      id: 2,
      name: "Kit Camiseta Dry Fit + Short Urban Cinza",
      price: 99.90,
    ...
    {
      id: 3,
      name: "Kit Camiseta Dry Fit + Short Tech Marinho",
      price: 109.90,
    ...
    {
      id: 4,
      name: "Kit Camiseta Performance + Short Sport Verde",
      price: 119.90,
    ...
    {
      id: 5,
      name: "Kit Camiseta Dry Fit + Short Premium Branco",
      price: 129.90,
    ...
    {
      id: 6,
      name: "Kit Camiseta Basic + Short Comfort Mescla",
      price: 79.90,
      originalPrice: 99.90,
      image: "/api/placeholder/300/400",
      colors: ["#6b7280", "#000000", "#374151"],
    ...
    {
      id: 7,
      name: "Kit Camiseta Training + Short Active Bordô",
      price: 104.90,
    ...
    {
      id: 8,
      name: "Kit Camiseta Flex + Short Dry Sport Azul",
      price: 114.90,
      originalPrice: 144.90,
      image: "/api/placeholder/300/400",
      colors: ["#0ea5e9", "#6b7280", "#000000"],
      sizes: ["P", "M", "G", "GG", "XGG"],
      rating: 4.8,
      reviews: 189,
      isNew: false,
      ...
      <section className="page-header">
        <div className="container">
          <div className="header-content">
            <h1>Kit Camiseta + Short</h1>
            <p>Combos ideais para treino e atividades físicas. Aproveite a economia dos nossos kits esportivos.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="filter-sort-bar">
            <div className="filter-controls">
              ...
              <span className="products-count">18 produtos</span>
            </div>
          ...
          <div className="quick-filters">
            ...
            <button className="quick-filter">Tech</button>
            <button className="quick-filter">Performance</button>
